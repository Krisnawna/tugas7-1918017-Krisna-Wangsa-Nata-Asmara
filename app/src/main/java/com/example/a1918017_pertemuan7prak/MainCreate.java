    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    Enama.requestFocus();
                    Toast.makeText(MainCreate.this, "Isi nama baju", Toast.LENGTH_SHORT).show();
                }
                else if (Sharga.equals("")) {
                    Eharga.requestFocus();
                    Toast.makeText(MainCreate.this, "Isi harga baju", Toast.LENGTH_SHORT).show();
                }
                else {
                    Enama.setText("");
                    Eharga.setText("");
                    ...
                    db.CreateBaju(new Baju(null, Snama, Sharga));
